            ...
            <div class="container">
                ...
                <div class="row">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-lg-8">
                                            <div class="modal-body">
                                                ...
                                                <p class="item-intro text-muted"><div id="lightValue"></div></p>
                    ...
                    <div class="portfolio-item">
                        ...
                        <div class="portfolio-caption">
                            <div class="portfolio-caption-heading">Poids grain</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 mb-4">
                    <!-- Capteur poids grain popup -->
                                ...
                                <div class="container">
                                    <div class="row justify-content-center">
                                        <div class="col-lg-8">
                                            <div class="modal-body">
                                                <!-- Project details -->
                                                <h2 class="text-uppercase">Poids grain </h2>
                                                <p class="item-intro text-muted"><div id="poidsgrainValue"></div></p>
                                ...
                                <div class="container">
                                    <div class="row justify-content-center">
                                        <div class="col-lg-8">
                                            <div class="modal-body">
                                                <!-- Project details -->
                                                <h2 class="text-uppercase">Poids poulet </h2>
                                                <p class="item-intro text-muted"><div id="poidspouletValue"></div></p>
                                                <img class="img-fluid d-block mx-auto" src="assets/img/portfolio/5.png" alt="..." />
                                                <button class="btn btn-primary btn-xl text-uppercase" data-bs-dismiss="modal" type="button">
                                                    Fermer la page <i class="fas fa-xmark me-1"></i>
                                                </button>
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-lg-8">
                                            <div class="modal-body">
                                                ...
                                                <p class="item-intro text-muted"><div id="potentiometerValue"></div></p>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <div class="modal-body">
                                        ...
                                        <p class="item-intro text-muted"><div id="ultrasoundValue"></div></p>
