                ...
                <div class="row gx-5 align-items-center">
                    ...
                    <div class="col-lg-6 order-lg-1">
                        <div class="p-5">
                            ...
                            <p>Au sud-est d'Amiens. La mairie va consulter les 500 habitants. Les communes voisines vont égalementdonner leur avis. Mais c'est la préfecture de la Somme qui tranchera dans quelques mois.</p>
                            <p>Des tas de craie et de gravats surplombent le village de Hailles. C'est ici, un peu en retraitdes habitations, que doit être construit un poulailler. Un projet, comme il en existe des milliers.Sauf qu'il doit accueillir 39 999 poulets exactement. A partir de 40 000 poulets, l'agriculteur à l'origine du projet de poulailler aurait dû lancer une enquête publique. Avec 39 999 poulets, uneconsultation publique suffit. Procédure plus courte et moins lourde.</p>
                            <p>La société du Moulin propose auBTS SN de la Providence d’étudier une solution technique pour aider à la gestion de l’élevage. Avecidentification et suivi du poids des poulets, alimentation automatique et gestion de l’environnement du poulailler.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row gx-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="p-5">
                            ...
                            <p> Chaque mangeoire (xN) est équipée d’un nano PC pour récupérer l’info sur le poids d’un poulet et son identifiant.La mangeoire peut être auto alimentée. Elle est équipée d’un distributeur automatique de graine. Grâce au système depesée le poulet identifié sur la balance peut avoir accès au réservoir ou non selon sa consommation de la journée encours. Un détecteur de présence au niveau du réservoir de grain permet de voir si le poulet vient pour manger (sinon lelecteur RFID peut détecter sa présence aux alentours de la mangeoire). Une fois le poulet à maturité il est marqué par un spray de peinture.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row gx-5 align-items-center">
                    ...
                    <div class="col-lg-6 order-lg-1">
                        <div class="p-5">
                            ...
                            <p>- Le choix de l’âge d’abattage : variable en fonction des espèces, pour le poulet entre 100 et 120 jours. Au sein d'une bande, il faut éviter de dépasser le délai
